...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://fitness-tracker-rails-api.herokuapp.com',
...
var workoutApi = __webpack_require__(8);
var workoutUi = __webpack_require__(19);

var onGetWorkouts = function onGetWorkouts(event) {
  // console.log('getting workouts')
  workoutApi.getWorkouts().then(workoutUi.getWorkoutsSuccess).catch(workoutUi.getWorkoutsError);
};
...
var onCreateWorkout = function onCreateWorkout(event) {
  ...
  workoutApi.createWorkout(data).then(workoutUi.createWorkoutSuccess).catch(workoutUi.createWorkoutError);
};
...
var onUpdateWorkout = function onUpdateWorkout(event) {
  ...
  workoutApi.updateWorkout(data, id).then(workoutUi.updateWorkoutSuccess).catch(workoutUi.updateWorkoutError);
};
...
var onDeleteWorkout = function onDeleteWorkout(event) {
  ...
  workoutApi.deleteWorkout(data).then(workoutUi.deleteWorkoutSuccess).catch(workoutUi.deleteWorkoutError);
};

var onResetWorkoutForms = function onResetWorkoutForms() {
  workoutUi.resetWorkoutForms();
};

module.exports = {
  onGetWorkouts: onGetWorkouts,
  onCreateWorkout: onCreateWorkout,
  onUpdateWorkout: onUpdateWorkout,
  onDeleteWorkout: onDeleteWorkout,
  onResetWorkoutForms: onResetWorkoutForms
};
...
var updateWorkout = function updateWorkout(data, id) {
  var url = config.apiUrl + '/workouts/' + id;
...
var deleteWorkout = function deleteWorkout(data) {
  // console.log('id is:', data)
  var url = config.apiUrl + '/workouts/' + data;
  // console.log('url is:', url)
  return $.ajax({
    method: 'DELETE',
...
var getFormFields = __webpack_require__(4);
var exerciseApi = __webpack_require__(11);
var exerciseUi = __webpack_require__(37);

var onGetExercises = function onGetExercises(event) {
  // console.log('getting exercises')
  exerciseApi.getExercises().then(exerciseUi.getExercisesSuccess).catch(exerciseUi.getExercisesError);
};
...
var onCreateExercise = function onCreateExercise(event) {
  ...
  var data = getFormFields(event.target);
  // console.log('data is', data)
  exerciseApi.createExercise(data).then(exerciseUi.createExerciseSuccess).catch(exerciseUi.createExerciseError);
};
...
var onUpdateExercise = function onUpdateExercise(event) {
  ...
  // console.log('data is', data)
  // console.log('id is', id)
  exerciseApi.updateExercise(data, id).then(exerciseUi.updateExerciseSuccess).catch(exerciseUi.updateExerciseError);
};
...
var onDeleteExercise = function onDeleteExercise(event) {
  ...
  var data = $(event.target).data('id');
  // console.log('id is', data)
  exerciseApi.deleteExercise(data).then(exerciseUi.deleteExerciseSuccess).catch(exerciseUi.deleteExerciseError);
};

var onResetExerciseForms = function onResetExerciseForms() {
  exerciseUi.resetExerciseForms();
};

module.exports = {
  onGetExercises: onGetExercises,
  onCreateExercise: onCreateExercise,
  onUpdateExercise: onUpdateExercise,
  onDeleteExercise: onDeleteExercise,
  onResetExerciseForms: onResetExerciseForms
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var updateExercise = function updateExercise(data, id) {
  var url = config.apiUrl + '/exercises/' + id;
  // console.log('url is:', url)
  return $.ajax({
    method: 'PATCH',
...
var deleteExercise = function deleteExercise(data) {
  // console.log('id is:', data)
  var url = config.apiUrl + '/exercises/' + data;
  // console.log('url is:', url)
  return $.ajax({
    method: 'DELETE',
...
var exerciseEvents = __webpack_require__(10);
var workoutEvents = __webpack_require__(7);
...
var onResetAuthForms = function onResetAuthForms() {
...
module.exports = {
  ...
  onSignOut: onSignOut,
  onResetAuthForms: onResetAuthForms
};
...
var workoutApi = __webpack_require__(8);
var showWorkoutsTemplate = __webpack_require__(20);
...
var getWorkoutsSuccess = function getWorkoutsSuccess(data) {
  ...
  if (Object.keys(data).length === 0) {
    ...
    var showWorkoutsHtml = showWorkoutsTemplate({ days: data });
    $('#workouts-container').empty();
    $('#workouts-container').append(showWorkoutsHtml);
  }
};

var getWorkoutsError = function getWorkoutsError(response) {
...
var createWorkoutSuccess = function createWorkoutSuccess(response) {
  ...
  workoutApi.getWorkouts().then(getWorkoutsSuccess).catch(getWorkoutsError);
};

var createWorkoutError = function createWorkoutError(response) {
  $('#create-workout-form')[0].reset();
...
var updateWorkoutSuccess = function updateWorkoutSuccess(response) {
...
var updateWorkoutError = function updateWorkoutError(response) {
  $('.update-workout-form')[0].reset();
...
var deleteWorkoutSuccess = function deleteWorkoutSuccess(response) {
...
var deleteWorkoutError = function deleteWorkoutError(response) {
...
var resetWorkoutForms = function resetWorkoutForms() {
  $('#create-workout-form')[0].reset();
  $('.update-workout-form')[0].reset();
};
...
module.exports = {
  ...
  getWorkoutsError: getWorkoutsError,
  createWorkoutSuccess: createWorkoutSuccess,
  createWorkoutError: createWorkoutError,
  updateWorkoutSuccess: updateWorkoutSuccess,
  updateWorkoutError: updateWorkoutError,
  deleteWorkoutSuccess: deleteWorkoutSuccess,
  deleteWorkoutError: deleteWorkoutError,
  resetWorkoutForms: resetWorkoutForms
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <th style=\"color:blue;\" align=\"center\" colspan=\"8\">"
    ...
    + "</th>\n\n"
    + ((stack1 = helpers.each.call(alias1,blockParams[0][0],{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
  ...
  return "\n        <tr>\n          <!-- <th scope=\"row\">"
    ...
    + "</th> -->\n              <td>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.exercise : stack1)) != null ? stack1.name : stack1), depth0))
    + "</td>\n              <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.tempo : stack1), depth0))
    + "</td>\n              <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.sets : stack1), depth0))
    + "</td>\n              <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.reps : stack1), depth0))
    + "</td>\n              <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rest_in_seconds : stack1), depth0))
    + "</td>\n              <td><button data-id="
    ...
    + "\" data-toggle=\"modal\" data-target=\"#update-workout-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Update</button></td>\n              <td><button data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " type=\"button\" class=\"btn btn-danger "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.user_id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#delete-workout-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button></td>\n        </tr>\n";
},"4":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),blockParams[0][0],{"name":"each","hash":{},"fn":container.program(5, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"5":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "<!-- Update Workout Modal -->\n<div id=\"update-workout-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"modal update-workout-modal workout-modal\" role=\"dialog\">\n  <div class=\"modal-dialog\">\n\n    <!-- Modal content-->\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\n        <h4 class=\"modal-title\">Update Workout</h4>\n      </div>\n      <div class=\"modal-body\">\n        <!-- update workout form -->\n          <form id=\"update-workout-form-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " class=\"update-workout-form\">\n            <div class=\"form-group\">\n              <label>Date Accomplished</label>\n              <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "\" name=\"workout[date]\" type=\"date\" class=\"form-control\">\n            </div>\n            <div class=\"form-group\">\n              <label>Select Exercise</label>\n              <select value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.exercise_id : stack1), depth0))
    + "\" name=\"workout[exercise_id]\" class=\"form-control\">\n                <option value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.exercise_id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.exercise : stack1)) != null ? stack1.name : stack1), depth0))
    + "</option>\n              </select>\n            </div>\n            <div class=\"form-group\">\n              <label>Tempo</label>\n              <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.tempo : stack1), depth0))
    + "\" name=\"workout[tempo]\" type=\"text\" class=\"form-control\" placeholder=\"Tempo\">\n            </div>\n            <div class=\"form-group\">\n              <label>Sets</label>\n              <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.sets : stack1), depth0))
    + "\" name=\"workout[sets]\" type=\"text\" class=\"form-control\" placeholder=\"How many sets?\">\n            </div>\n            <div class=\"form-group\">\n              <label>Reps</label>\n              <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.reps : stack1), depth0))
    + "\" name=\"workout[reps]\" type=\"text\" class=\"form-control\" placeholder=\"How many Reps per set?\">\n            </div>\n            <div class=\"form-group\">\n              <label>Rest in Seconds</label>\n              <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rest_in_seconds : stack1), depth0))
    + "\" type=\"text\" name=\"workout[rest_in_seconds]\" class=\"form-control\" placeholder=\"How many seconds of rest?\">\n            </div>\n            <button data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " type=\"submit\" class=\"btn btn-primary\">Update Workout</button>\n          </form>\n      </div>\n    </div>\n  </div>\n</div>\n";
},"7":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),blockParams[0][0],{"name":"each","hash":{},"fn":container.program(8, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"8":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "  <!-- delete workout modal -->\n      <div id=\"delete-workout-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"workout-modal-handlebars workout-modal delete-workout modal delete-workout-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"deleteWorkout\" aria-hidden=\"true\">\n        <div class=\"modal-dialog modal-lg\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h3 class=\"modal-title\">Are you sure you want to Delete?!</h3>\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                  <span aria-hidden=\"true\">&times;</span>\n                </button>\n            </div>\n            <form data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " class=\"delete-workout-form\">\n              <div class=\"modal-body\">\n                <!-- delete button -->\n                <button data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " type=\"submit\" class=\"btn btn-primary\">Yes, delete</button>\n              </div>\n            </form>\n          </div>\n        </div>\n      </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return "<table class=\"table\">\n  <thead>\n    <tr>\n      <!-- <th scope=\"col\">Date</th> -->\n      <th scope=\"col\">Exercise</th>\n      <th scope=\"col\">Tempo</th>\n      <th scope=\"col\">Sets</th>\n      <th scope=\"col\">Reps</th>\n      <th scope=\"col\">Rest (secs)</th>\n      <th scope=\"col\">Update</th>\n      <th scope=\"col\">Delete</th>\n    </tr>\n  </thead>\n  <tbody>\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.days : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </tbody>\n</table>\n\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.days : depth0),{"name":"each","hash":{},"fn":container.program(4, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.days : depth0),{"name":"each","hash":{},"fn":container.program(7, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var store = __webpack_require__(2);
var showExercisesTemplate = __webpack_require__(38);
var dropdownExercisesTemplate = __webpack_require__(39);
var exerciseApi = __webpack_require__(11);
...
var getExercisesSuccess = function getExercisesSuccess(data) {
  ...
  if (data.exercises.length === 0) {
    ...
    var showExercisesHtml = showExercisesTemplate({ object: data });
    $('#exercise-container').empty();
    $('#exercise-container').append(showExercisesHtml);
    var exerciseDropdownHTML = dropdownExercisesTemplate({ object: data });
...
var getExercisesError = function getExercisesError(response) {
...
var createExerciseSuccess = function createExerciseSuccess(response) {
  ...
  exerciseApi.getExercises().then(getExercisesSuccess).catch(getExercisesError);
};

var createExerciseError = function createExerciseError(response) {
  $('#create-exercise-form')[0].reset();
...
var updateExerciseSuccess = function updateExerciseSuccess(response) {
  // console.log(response)
...
var updateExerciseError = function updateExerciseError(response) {
  $('.update-exercise-form')[0].reset();
...
var deleteExerciseSuccess = function deleteExerciseSuccess(response) {
...
var deleteExerciseError = function deleteExerciseError(response) {
...
var resetExerciseForms = function resetExerciseForms() {
  $('#create-exercise-form')[0].reset();
  $('.update-exercise-form')[0].reset();
};
...
module.exports = {
  ...
  getExercisesError: getExercisesError,
  ...
  deleteExerciseSuccess: deleteExerciseSuccess,
  deleteExerciseError: deleteExerciseError,
  resetExerciseForms: resetExerciseForms
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"card col-md-4 col-sm-6\">\n      <iframe src=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " type=\"button\" class=\"btn btn-primary signed-in-visible exercise-button exercise-button-"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.user : stack1)) != null ? stack1.id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#update-exercise-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Update</button>\n        <button style=\"display: none;\" data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " type=\"button\" class=\"btn btn-danger signed-in-visible exercise-button exercise-button-"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.user : stack1)) != null ? stack1.id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#delete-exercise-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button>\n      </div>\n    </div>\n";
},"4":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
  ...
  return "    <!-- Update Exercise Modal -->\n    <div id=\"update-exercise-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"modal update-exercise-modal exercise-modal\" role=\"dialog\">\n      <div class=\"modal-dialog\">\n\n        <!-- Modal content-->\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\n            <h4 class=\"modal-title\">Update Exercise</h4>\n          </div>\n          <div class=\"modal-body\">\n            <!-- update exercise form -->\n            <form id=\"update-exercise-form-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " class=\"update-exercise-form\">\n              <div class=\"form-group\">\n                <label>Exercise Name</label>\n                <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\" name=\"exercise[name]\" type=\"text\" class=\"form-control\" placeholder=\"Name\">\n              </div>\n              <div class=\"form-group\">\n                <label>Exercise Description</label>\n                <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "\" name=\"exercise[description]\" type=\"text\" class=\"form-control\" placeholder=\"Description\">\n              </div>\n              <div class=\"form-group\">\n                <label>Link to image or video</label>\n                <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.link : stack1), depth0))
    + "\" name=\"exercise[link]\" type=\"text\" class=\"form-control\" placeholder=\"Link\">\n              </div>\n              <button data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " type=\"submit\" class=\"btn btn-primary\">Update Exercise</button>\n            </form>\n          </div>\n        </div>\n      </div>\n    </div>\n";
},"7":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
  ...
  return "    <!-- delete exercise modal -->\n    <div id=\"delete-exercise-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"exercise-modal-handlebars exercise-modal delete-exercise modal delete-exercise-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"deleteExercise\" aria-hidden=\"true\">\n      <div class=\"modal-dialog modal-lg\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h3 class=\"modal-title\">Are you sure you want to Delete?!</h3>\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                  <span aria-hidden=\"true\">&times;</span>\n                </button>\n          </div>\n          <form data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
  ...
  return ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.object : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.object : depth0),{"name":"each","hash":{},"fn":container.program(4, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.object : depth0),{"name":"each","hash":{},"fn":container.program(7, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.object : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
